...
const Navbar = () => {
    ...
    return (
        <nav className="bg-pink-600 bg-opacity-95 lg:sticky  top-0 lg:h-20 md:h-44 sm:h-44 shadow-md shadow-gray-500">
            {/* main  */}
            <div className="lg:flex lg:justify-between items-center py-5 lg:px-3 ">
                {/* left  */}
                <div className="left py-3 lg:py-0">
                    <Link to={'/'}>
                        <h2 className=" font-bold text-white text-2xl text-center new-font lg:mx-5">E-Bharat</h2>
                    </Link>
                </div>
